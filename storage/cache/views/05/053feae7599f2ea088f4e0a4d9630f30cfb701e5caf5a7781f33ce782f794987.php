...
/* /auth/sign-in.twig */
class __TwigTemplate_e99391b78d8bd1dc06a03c8bb49d0003af9d0e4918cc1547a93e56d3f4b86a9d extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("/auth/layout.twig", "/auth/sign-in.twig", 1);
    ...
    ";
        // line 6
        yield from         $this->loadTemplate("/auth/_partials/navbar.twig", "/auth/sign-in.twig", 6)->unwrap()->yield($context);
        // line 7
        yield "
    <main class=\"main-content mt-0\">
        ...
        yield "\" method=\"post\">
                                    ...
                                    <div class=\"form-check form-switch\">
                                        <input id=\"persist\" name=\"persist\" class=\"form-check-input\" type=\"checkbox\" checked=\"\">
                                        <label class=\"form-check-label\" for=\"persist\">Remember me</label>
                                    </div>
                                    <div class=\"text-center\">
                                        <button type=\"submit\" class=\"btn bg-gradient-";
        // line 86
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["setup"] ?? null), "app_color", [], "any", false, false, false, 86), "html", null, true);
        yield " w-100 my-4 mb-2\">
                                            Sign in
                                        </button>
                                        <!-- CSRF protection -->
                                        ";
        // line 90
        yield CoreExtension::getAttribute($this->env, $this->source, ($context["csrf"] ?? null), "field", [], "any", false, false, false, 90);
        yield "
                                    </div>
                                    ";
        // line 93
        yield "                                    <div class=\"mb-2 position-relative text-center\">
                                        <p class=\"text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3\">
                                            ";
        // line 96
        yield "                                            eller
        ...
        yield "\" class=\"btn bg-gradient-dark w-100 mt-2 mb-4\">
                                            ";
        // line 102
        yield "                                            opret bruger
                                        </a>
        ...
        ";
        // line 114
        yield from         $this->loadTemplate("/auth/_partials/footer.twig", "/auth/sign-in.twig", 114)->unwrap()->yield($context);
        // line 115
        yield "
    </main>
...
";
    ...
    {
        return array (  183 => 115,  181 => 114,  167 => 102,  163 => 100,  157 => 96,  153 => 93,  148 => 90,  141 => 86,  126 => 74,  57 => 7,  55 => 6,  51 => 4,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends \"/auth/layout.twig\" %}
                ...
                <div class=\"row mt-lg-n10 mt-md-n11 mt-n10\">
                    <div class=\"col-xl-4 col-lg-5 col-md-7 mx-auto\">
                        <div class=\"card z-index-0\">
                            ...
                            <div class=\"card-body\">
                                <form action=\"{{ path_for('auth.sign-in') }}\" method=\"post\">
                                    <div class=\"mb-3\">
                                        <input id=\"email\" name=\"email\" type=\"email\" class=\"form-control\" placeholder=\"Email\" aria-label=\"Email\" aria-describedby=\"email-addon\">
                                    </div>
                                    <div class=\"mb-3\">
                                    ...
                                    <div class=\"text-center\">
                                        <button type=\"submit\" class=\"btn bg-gradient-{{ setup.app_color }} w-100 my-4 mb-2\">
                                            Sign in
                                        </button>
                                        <!-- CSRF protection -->
                                        {{ csrf.field | raw }}
                                    </div>
                                    {#                                <p class=\"text-sm mt-3 mb-0\">Don't have an account? <a href=\"javascript:\" class=\"text-dark font-weight-bolder\">Sign up</a></p>#}
                                    <div class=\"mb-2 position-relative text-center\">
                                        <p class=\"text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3\">
                                            {#                                        {{ trans('auth.usi.button_separator') }}#}
                                            eller
                                        </p>
                                    </div>
                                    <div class=\"text-center\">
                                        <a href=\"{{ path_for('auth.sign-up') }}\" class=\"btn bg-gradient-dark w-100 mt-2 mb-4\">
                                            {#                                        {{ trans('auth.usi.go_to_signup_button') }}#}
                                            opret bruger
                                        </a>
                                    </div>
                                </form>
...
{% endblock %}", "/auth/sign-in.twig", "/var/www/tune-trafikskole.dk/portfolio/src/views/auth/sign-in.twig");
    }
}
