...
/* /auth/_partials/navbar.twig */
class __TwigTemplate_e90b975d125455e5b1948cffe9ef7b27e0f091566d3a67df092e1c3f80566cdd extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        yield "<nav class=\"navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4\">
    <div class=\"container\">
        ...
        yield "\">
                ...
                <li class=\"nav-item\">
                    <a class=\"nav-link me-2\" href=\"";
        // line 31
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Slim\Views\TwigExtension']->pathFor("auth.sign-up"), "html", null, true);
        yield "\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i18n"]) {
            // line 47
            yield "                            ";
            if ((0 === CoreExtension::compare($this->extensions['app\views\extensions\TranslationExtension']->locale(), CoreExtension::getAttribute($this->env, $this->source, $context["i18n"], "code", [], "any", false, false, false, 47)))) {
                // line 48
                yield "                                ";
                yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["i18n"], "name", [], "any", false, false, false, 48), "html", null, true);
                yield "
                            ";
            }
            // line 50
        ...
        yield "/public/assets/ic_down_arrow_white.svg\" alt=\"down-arrow\" class=\"arrow ms-1 d-lg-block d-none\">
                    </a>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i18n"]) {
            // line 57
            yield "                                    ";
            if ((0 !== CoreExtension::compare($this->extensions['app\views\extensions\TranslationExtension']->locale(), CoreExtension::getAttribute($this->env, $this->source, $context["i18n"], "code", [], "any", false, false, false, 57)))) {
                // line 58
                yield "                                        <li class=\"nav-item list-group-item border-0 p-0\">
                                            <a class=\"dropdown-item py-2 ps-3 border-radius-md\" href=\"https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-dashboard\">
                                                <div class=\"d-flex\">
                                                    ...
                                                    <div>
                                                        <h6 class=\"dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0\" href=\"";
                // line 79
                yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Slim\Views\TwigExtension']->pathFor("translate.switch", ["lang" => CoreExtension::getAttribute($this->env, $this->source, $context["i18n"], "code", [], "any", false, false, false, 79)]), "html", null, true);
                yield "\">
                                                            ";
                // line 80
                yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["i18n"], "name", [], "any", false, false, false, 80), "html", null, true);
                yield "
                                                        </h6>
                                                    </div>
                                                </div>
        ...
        yield "                            </ul>
            ...
            <div class=\"nav-item d-flex align-items-center\">
                <a class=\"btn btn-round btn-sm mb-0 btn-outline-white me-2\" target=\"_blank\" href=\"https://www.creative-tim.com/builder?ref=navbar-soft-ui-dashboard\">
                    Online Builder
                </a>
            </div>
            <ul class=\"navbar-nav d-lg-block d-none\">
                <li class=\"nav-item\">
                    <a href=\"https://www.creative-tim.com/product/soft-ui-dashboard\" class=\"btn btn-sm btn-round mb-0 me-1 bg-gradient-";
        // line 223
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["setup"] ?? null), "app_color", [], "any", false, false, false, 223), "html", null, true);
        yield "\">
                        Free download
                    </a>
                </li>
    ...
    {
        return "/auth/_partials/navbar.twig";
    }
    ...
    {
        return array (  312 => 223,  175 => 88,  169 => 87,  159 => 80,  155 => 79,  132 => 58,  129 => 57,  125 => 56,  116 => 51,  110 => 50,  104 => 48,  101 => 47,  97 => 46,  86 => 38,  76 => 31,  59 => 17,  42 => 3,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<nav class=\"navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4\">
    <div class=\"container\">
        <a class=\"navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white\" href=\"{{ path_for('home') }}\">
            Soft UI Dashboard
        </a>
        <button class=\"navbar-toggler shadow-none ms-2\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navigation\" aria-controls=\"navigation\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
            <span class=\"navbar-toggler-icon mt-2\">
        ...
        <div class=\"collapse navbar-collapse\" id=\"navigation\">
            <ul class=\"navbar-nav mx-auto ms-xl-auto me-xl-7\">
                <!-- home -->
                <li class=\"nav-item\">
                    <a class=\"nav-link d-flex align-items-center me-2 active\" aria-current=\"page\" href=\"{{ path_for('home') }}\">
                        <i class=\"fa fa-chart-pie opacity-6  me-1\"></i>
                        Home
                    </a>
                </li>
                ...
                <!-- auth -> sign UP -->
                <li class=\"nav-item\">
                    <a class=\"nav-link me-2\" href=\"{{ path_for('auth.sign-up') }}\">
                        <i class=\"fas fa-user-circle opacity-6  me-1\"></i>
                        Sign Up
                    </a>
                </li>
                <!-- auth -> sign IN -->
                <li class=\"nav-item\">
                    <a class=\"nav-link me-2\" href=\"{{ path_for('auth.sign-in') }}\">
                        <i class=\"fas fa-key opacity-6  me-1\"></i>
                        Sign In
                    </a>
                </li>
                ...
                <li class=\"nav-item dropdown dropdown-hover mx-2\">
                    <a role=\"button\" class=\"nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center \" id=\"dropdownMenuDocs\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                        {% for i18n in locales %}
                            ...
                            {% endif %}
                        {% endfor %}
                        <img src=\"{{ base_url() }}/public/assets/ic_down_arrow_white.svg\" alt=\"down-arrow\" class=\"arrow ms-1 d-lg-block d-none\">
                    </a>
                    <div class=\"dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg\" aria-labelledby=\"dropdownMenuDocs\">
                        <div class=\"d-none d-lg-block\">
                            <ul class=\"list-group\">
                                        ...
                                        <li class=\"nav-item list-group-item border-0 p-0\">
                                            <a class=\"dropdown-item py-2 ps-3 border-radius-md\" href=\"https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-dashboard\">
                                                <div class=\"d-flex\">
                                                    ...
                                                    <div>
                                                        <h6 class=\"dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0\" href=\"{{ path_for('translate.switch', {lang: i18n.code}) }}\">
                                                            {{ i18n.name }}
                                                        </h6>
                                                    </div>
                                                </div>
            ...
            <ul class=\"navbar-nav d-lg-block d-none\">
                <li class=\"nav-item\">
                    <a href=\"https://www.creative-tim.com/product/soft-ui-dashboard\" class=\"btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ setup.app_color }}\">
                        Free download
                    </a>
                </li>
            </ul>
...
</nav>", "/auth/_partials/navbar.twig", "/var/www/tune-trafikskole.dk/portfolio/src/views/auth/_partials/navbar.twig");
    }
}
